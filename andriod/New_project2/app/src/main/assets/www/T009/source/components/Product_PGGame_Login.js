define('T009/source/components/Product_PGGame_Login', ["require", "exports", "T009/source/modules/global", "Global/source/modules/api"], function (require, exports, Global, Api) {
    "use strict";
    var Product_PGGame_Login = /** @class */ (function () {
        function Product_PGGame_Login() {
            this.messageNS = "";
            this.toLoadSiteMessage();
            //this.init();
        }
        Product_PGGame_Login.prototype.toLoadSiteMessage = function () {
            var _this = this;
            ...
            Api.message.site_message()
                ...
                if (sitemessage.pggame.state) {
                    //设置维护内容
                    $('[data-cashap-id="maintenanceInfo"]').html(sitemessage.pggame.info["zh-cn"]);
        ...
        Product_PGGame_Login.prototype.init = function () {
            var _this = this;
            Global.Log.log("Product_PGGame_Login.init");
            if (Global.App.isLogin()) {
                Api.account.profile_baseInfo(true)
                    .done(function (baseInfo) {
                    if (Global.App.accessCheck(Com_Gametree_Cashap.SiteConfig.memberRuleId.PGGame, baseInfo.memberLevel)) {
                        _this.loadLoginInfo();
                    }
                });
            }
                ...
                //此处默认会弹出 提示登录 的信息
                Global.App.accessCheck(Com_Gametree_Cashap.SiteConfig.memberRuleId.PGGame, -1);
            }
        };
        /**
         * 获取产品登录信息
         */
        Product_PGGame_Login.prototype.loadLoginInfo = function () {
            var _this = this;
            ...
            Api.pggame.login_product(data)
                .done(function (result) {
                _this.loadLoginInfo_callBack(result);
            });
        };
        Product_PGGame_Login.prototype.loadLoginInfo_callBack = function (result) {
            if (result.errorInfo.length > 0 || !result.result) {
                ...
                if (result.errorInfo[0].errorCode == "1000050") {
                    var productName = Com_Gametree_Cashap.Language.getMessage_Translate("Model.Game_ID", "PGGame");
        ...
        return Product_PGGame_Login;
    }());
    return Product_PGGame_Login;
});
//# sourceMappingURL=/SGMobile_H5App_V1/T009/source/components/Product_PGGame_Login.js.map