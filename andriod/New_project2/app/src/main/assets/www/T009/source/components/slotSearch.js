define('T009/source/components/slotSearch', ["require", "exports", "T009/source/modules/global", "Global/source/modules/api", "handlebars", "Global/libs/zepto.picLazyLoad"], function (require, exports, Global, Api, Handlebars) {
    "use strict";
    ...
    var search = /** @class */ (function () {
        ...
        search.prototype.openProductURL = function (item) {
            var url;
            if (item.GameName === "megawincasino") {
                ...
                url = item.GameName + "_Login.html?" + item.Param;
            }
            window.open(url);
        };
        ...
        search.prototype.searchByName = function (locationParam) {
            ...
            Api.allGame.getGameList(data)
                ...
                if (result.data === null || result.data === undefined) {
                    ...
                    result.data = result.data.filter(function (item) { return item.GameName !== 'kygame'; });
...
//# sourceMappingURL=/SGMobile_H5App_V1/T009/source/components/slotSearch.js.map