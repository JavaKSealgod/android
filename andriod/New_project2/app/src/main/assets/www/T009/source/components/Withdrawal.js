define('T009/source/components/Withdrawal', ["require", "exports", "T009/source/modules/global", "Global/source/modules/api", "handlebars", "iSlider"], function (require, exports, Global, Api, Handlebars, iSlider) {
    "use strict";
    var withdrawalPage = /** @class */ (function () {
        ...
        withdrawalPage.prototype.drawingsBank_list_callback = function (result) {
            ...
            var banklist_hight = screen.availHeight - ($(".header").height() + $(".page-desc").height() + $(".footer").height());
            var bankItem_hight = $(this.bankItem).height();
            var data = [], amountPerGroup = (banklist_hight - banklist_hight % bankItem_hight) / bankItem_hight || $(this.bankGroupTpl).data("group-amount") || 7, arr = [], cache = [];
...
//# sourceMappingURL=/SGMobile_H5App_V1/T009/source/components/Withdrawal.js.map