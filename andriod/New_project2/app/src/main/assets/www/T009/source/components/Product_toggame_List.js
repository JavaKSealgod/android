define('T009/source/components/Product_toggame_List', ["require", "exports", "T009/source/modules/global", "Global/source/modules/api", "handlebars", "Global/libs/zepto.picLazyLoad"], function (require, exports, Global, Api, Handlebars) {
    "use strict";
    // import BackToTop = require("../../../Global/source/widgets/BackToTop");
    var Product_toggame_List = /** @class */ (function () {
        function Product_toggame_List(compOption) {
            this.messageNS = "";
        ...
        Product_toggame_List.prototype.toLoadSiteMessage = function () {
            var _this = this;
        ...
        Product_toggame_List.prototype.init = function () {
            var _this = this;
        ...
        Product_toggame_List.prototype.productListLoadCallback = function (data) {
            //加入游戏至productList
            var productList = [];
         ...
         * 游戏搜索
         */
        Product_toggame_List.prototype.searchByName = function () {
        ...
        Product_toggame_List.prototype.toOpenProductURL = function (GameId) {
            var _this = this;
        ...
        Product_toggame_List.prototype.setGameList = function (productList) {
         ...
         * 创建html结构
         */
        Product_toggame_List.prototype.setHtml = function (target, data, tpl) {
            var template = Handlebars.compile(tpl), html = template(data);
            target.html(html);
        };
        return Product_toggame_List;
    }());
    return Product_toggame_List;
});
//# sourceMappingURL=/SGMobile_H5App_V1/T009/source/components/Product_toggame_List.js.map