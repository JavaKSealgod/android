define('T009/source/components/Product_SGGame_Login', ["require", "exports", "T009/source/modules/global", "Global/source/modules/api"], function (require, exports, Global, Api) {
    "use strict";
    var Product_SGGame_Login = /** @class */ (function () {
        function Product_SGGame_Login() {
            this.messageNS = "Product_SGGame_Login";
            this.toLoadSiteMessage();
            //this.init();
        }
        Product_SGGame_Login.prototype.toLoadSiteMessage = function () {
            var _this = this;
        ...
        Product_SGGame_Login.prototype.init = function () {
            var _this = this;
            Global.Log.log("Product_SGGame_Login.init");
        ...
        Product_SGGame_Login.prototype.loadLoginInfo = function () {
            var _this = this;
            var id = Global.Util.getParam("id");
            if (id === undefined) {
            ...
            var data = { "id": id };
            Api.sggame.login_product(data)
                .done(function (result) {
                _this.loadLoginInfo_callBack(result);
            });
        };
        Product_SGGame_Login.prototype.loadLoginInfo_callBack = function (result) {
        ...
        return Product_SGGame_Login;
    }());
    return Product_SGGame_Login;
});
//# sourceMappingURL=/SGMobile_H5App_V1/T009/source/components/Product_SGGame_Login.js.map