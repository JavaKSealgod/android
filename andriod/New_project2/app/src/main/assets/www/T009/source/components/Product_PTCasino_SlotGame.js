define('T009/source/components/Product_PTCasino_SlotGame', ["require", "exports", "T009/source/modules/global", "Global/source/modules/api", "handlebars", "Global/libs/zepto.picLazyLoad"], function (require, exports, Global, Api, Handlebars) {
    "use strict";
    ...
    var Product_PTCasino_SlotGame = /** @class */ (function () {
        ...
        Product_PTCasino_SlotGame.prototype.toLoadProductList = function (data) {
            ...
            Api.ptcasino.product_list(data)
                ...
                //隐藏系统loading
                Global.Tips.hideSystemLoading();
                _this.content.Product_List = result;
        ...
        Product_PTCasino_SlotGame.prototype.toLoadProductListCallback = function (result) {
            ...
            var data = this.content.Product_List.data, imgFolder = Com_Gametree_Cashap.Language.fileDomain + "/ptcasino/gameicon/";
        ...
        Product_PTCasino_SlotGame.prototype.filterData = function () {
            ...
            data.forEach(function (item, idx) {
                if (gameName != "") {
                    if (item.gameName.toLowerCase().indexOf(gameName.toLowerCase()) > -1)
        ...
        Product_PTCasino_SlotGame.prototype.getGameListItemByGameCode = function (code) {
            var data = this.content.Product_List.data, target;
            data.forEach(function (item, idx) {
                ...
                Api.account.profile_baseInfo(true)
                    ...
                    if (Global.App.accessCheck(Com_Gametree_Cashap.SiteConfig.memberRuleId.PTCasino, baseInfo.memberLevel)) {
                        if (baseInfo.memberLevel == Global.MemberLevel.trial) {
                            ...
                            var url = _this.loginUrl + "?gameCode=" + item.gameCode;
                            window.open(url);
                        }
                    }
                });
...
//# sourceMappingURL=/SGMobile_H5App_V1/T009/source/components/Product_PTCasino_SlotGame.js.map