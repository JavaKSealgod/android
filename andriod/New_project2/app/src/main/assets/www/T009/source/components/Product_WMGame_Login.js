 ...
 * 产品组件--WM电子产品系列
 */
define('T009/source/components/Product_WMGame_Login', ["require", "exports", "T009/source/modules/global", "Global/source/modules/api"], function (require, exports, Global, Api) {
    "use strict";
    var Product_WMGame_Login = /** @class */ (function () {
        function Product_WMGame_Login() {
            this.messageNS = "";
            this.toLoadSiteMessage();
            //this.init();
        }
        Product_WMGame_Login.prototype.toLoadSiteMessage = function () {
            var _this = this;
            ...
            Api.message.site_message()
                ...
                if (sitemessage.wmgame.state) {
                    //设置维护内容
                    $('[data-cashap-id="maintenanceInfo"]').html(sitemessage.wmgame.info["zh-cn"]);
        ...
        Product_WMGame_Login.prototype.init = function () {
            var _this = this;
            Global.Log.log("Product_wmgame_Login.init");
            if (Global.App.isLogin()) {
                Api.account.profile_baseInfo(true)
                    .done(function (baseInfo) {
                    if (Global.App.accessCheck(Com_Gametree_Cashap.SiteConfig.memberRuleId.WMGame, baseInfo.memberLevel)) {
                        _this.loadLoginInfo();
                    }
                });
            }
                ...
                //此处默认会弹出 提示登录 的信息
                Global.App.accessCheck(Com_Gametree_Cashap.SiteConfig.memberRuleId.WMGame, -1);
            }
        };
        /**
         * 获取产品登录信息
         */
        Product_WMGame_Login.prototype.loadLoginInfo = function () {
            var _this = this;
            ...
            var d = { "id": id };
            Api.wmgame.login_product(d)
                .done(function (result) {
                _this.loadLoginInfo_callBack(result);
            });
        };
        Product_WMGame_Login.prototype.loadLoginInfo_callBack = function (result) {
            if (result.errorInfo.length > 0 || !result.result) {
                ...
                if (result.errorInfo[0].errorCode == "1000050") {
                    var productName = Com_Gametree_Cashap.Language.getMessage_Translate("Model.Game_ID", "WMGame");
        ...
        return Product_WMGame_Login;
    }());
    return Product_WMGame_Login;
});
//# sourceMappingURL=/SGMobile_H5App_V1/T009/source/components/Product_WMGame_Login.js.map